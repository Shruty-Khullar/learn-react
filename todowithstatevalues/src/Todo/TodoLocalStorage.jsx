...
import { getLocalStorage, setLocalStorage } from './TodoLocalStorageHelp';
const todoKey = "reactTodo";
export const TodoLocalStorage = () => {
    //Better to use as globval var
    // const todoKey = "reactTodo";

    const [dateTime, setDateTime] = useState("");
    //if data exist in localStorage take from there so as we dont miss old dsata on refresh
    ...
    //it need 2 params -> key string (name in localStorage), value also as string
